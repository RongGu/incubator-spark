...
class BlockManagerSuite extends FunSuite with BeforeAndAfter with PrivateMethodTester {
  ...
  test("master + 1 manager interaction") {
    store = new BlockManager("<driver>", actorSystem, master, serializer, 2000, 2000, conf)
  ...
  test("master + 2 managers interaction") {
    store = new BlockManager("exec1", actorSystem, master, serializer, 2000, 2000, conf)
    store2 = new BlockManager("exec2", actorSystem, master, new KryoSerializer(conf), 2000, 2000, conf)
  ...
  test("in-memory LRU storage") {
    store = new BlockManager("<driver>", actorSystem, master, serializer, 1200, 1200, conf)
    val a1 = new Array[Byte](400)
    val a2 = new Array[Byte](400)
    val a3 = new Array[Byte](400)
    store.putSingle("a1", a1, StorageLevel.MEMORY_ONLY)
  ...
  test("overly large block") {
    store = new BlockManager("<driver>", actorSystem, master, serializer, 500, 500, conf)
  ...
  test("block compression") {
    try {
      ...
      store = new BlockManager("exec2", actorSystem, master, serializer, 2000, 2000, conf)
      store.putSingle(ShuffleBlockId(0, 0, 0), new Array[Byte](1000), StorageLevel.MEMORY_ONLY_SER)
      ...
      store = new BlockManager("exec3", actorSystem, master, serializer, 2000, 2000, conf)
      ...
      store = new BlockManager("exec4", actorSystem, master, serializer, 2000, 2000, conf)
      store.putSingle(BroadcastBlockId(0), new Array[Byte](1000), StorageLevel.MEMORY_ONLY_SER)
      ...
      store = new BlockManager("exec5", actorSystem, master, serializer, 2000, 2000, conf)
      ...
      store = new BlockManager("exec6", actorSystem, master, serializer, 2000, 2000, conf)
      store.putSingle(rdd(0, 0), new Array[Byte](1000), StorageLevel.MEMORY_ONLY_SER)
      ...
      store = new BlockManager("exec7", actorSystem, master, serializer, 2000, 2000, conf)
  ...
  test("block store put failure") {
    ...
    store = new BlockManager("<driver>", actorSystem, master, new JavaSerializer(conf), 1200, 2000, conf)
