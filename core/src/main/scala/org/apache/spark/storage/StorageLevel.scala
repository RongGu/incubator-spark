...
object StorageLevel {
  ...
  val TACHYON_ONLY = new StorageLevel(false, false, true, false)
  val TACHYON_ONLY_2 = new StorageLevel(false, false, true, false, 2)
  val TACHYON_AND_DISK = new StorageLevel(true, false, true, false) 
